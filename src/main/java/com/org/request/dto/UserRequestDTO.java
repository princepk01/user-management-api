...
public class UserRequestDTO implements Serializable {
	...
	private static final long serialVersionUID = -4246055616482350714L;
	...
	public String toString() {
		return "UserRequestDTO [id=" + id + ", userId=" + userId + ", name=" + name + ", dateOfBirth=" + dateOfBirth
